...
<%@page import="com.nit.Setting"%>
<%@page import="com.nit.util.SettingUtils"%>
<%@page import="com.nit.util.SpringUtils"%>
<%@page import="com.nit.Setting.CaptchaType"%>
<%@page import="com.nit.Setting.AccountLockType"%>
<%@page import="com.nit.service.RSAService"%>
...
<script type="text/javascript"
	src="<%=base%>/resources/common/js/jsbn.js"></script>
<script type="text/javascript"
	src="<%=base%>/resources/common/js/prng4.js"></script>
...
<script type="text/javascript"
	src="<%=base%>/resources/common/js/base64.js"></script>
<script type="text/javascript"
		...
		$loginForm.submit( function() {
			if ($username.val() == "") {
				$.message("warn", "<%=SpringUtils
						.getMessage("admin.login.usernameRequired")%>");
				return false;
			}
			if ($password.val() == "") {
				$.message("warn", "<%=SpringUtils
						.getMessage("admin.login.passwordRequired")%>");
				return false;
			}
			if ($captcha.val() == "") {
...
<body class="login">
	...
	<div class="login_main">
		...
		<div class="login_middle">
			<div class="login_middle_main">
				<div class="middle_ad">
					...
					<div class="middle_ad">
						<img src="<%=base%>/resources/admin/images/login_ad.jpg" />
					</div>
				</div>
				<div class="middle_lg">
					<form id="loginForm" action="login.jsp" method="post">
						...
						<table class="loginTable">
							...
							<tr>
								<td>&nbsp;</td>
								<th>&nbsp;</th>
								<td><input type="submit" class="submitButton" value=""
									hidefocus /></td>
							</tr>
						</table>
					</form>
		...
		<div class="login_footer">
			<div class="powered">
				<%=siteName%>
				版权所有 2002-2013 All Rights Reserved 备案：<%=certtext%>
			</div>
		</div>
	</div>
	<%
	...
	<fieldset>
		...
		<p>
			请检查WIT程序是否已正确安装 [<a href="<%=base%>/install/">点击此处进行安装</a>]
		</p>
		<p>
